<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Video.View.Settings_TagDashboard, App_Web_settings_tagdashboard.ascx.24b431c5" %>
<%@ Register TagPrefix="dnn" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<%@ Register TagPrefix="dnn" TagName="sectionhead" Src="~/controls/SectionHeadControl.ascx" %>
<%@ Register TagPrefix="dnn" Assembly="DotNetNuke" Namespace="DotNetNuke.UI.WebControls" %>
<table id="tblGeneral" cellspacing="0" cellpadding="2" width="95%" border="0" runat="server" class="dnnFormItem"
    align="center">
    <tr>
    ...
    <tr>
        ...
        <td >
            ...
            <a id="pickTcolor2" name="pickTcolor2" href="javascript:void(PickTcolor2())" target="_self">
                <asp:Image ID="Image2" runat="server" ImageAlign="Top" ResourceKey="PickColor" ImageUrl="~/DesktopModules/CrossVideo/Images/ColorPick.jpg" /></a>&nbsp;
        </td>
    </tr>
    <tr>
        <td style="width: 200px">
        ...
        <td >
            ...
            <a id="pickHicolor" name="pickHicolor" href="javascript:void(PickHicolor())" target="_self">
                <asp:Image ID="Image3" runat="server" ImageAlign="Top" ResourceKey="PickColor" ImageUrl="~/DesktopModules/CrossVideo/Images/ColorPick.jpg" /></a>&nbsp;
...
<p align="center">
   ...
   <asp:HyperLink runat="server" ID="hlCancel" ResourceKey="cmdReturn" CssClass="dnnSecondaryAction" NavigateUrl="<%#DotNetNuke.Common.Globals.NavigateURL(TabId)%>" />
</p>
