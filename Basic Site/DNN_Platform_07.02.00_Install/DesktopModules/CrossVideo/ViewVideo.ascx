<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Video.View.ViewVideo, App_Web_viewvideo.ascx.24b431c5" %>
...
<asp:Label ID="lblVideoNotExist" runat="server" resourcekey="lblVideoNotExist" CssClass="NormalRed"
    Visible="false"></asp:Label>
<asp:Label ID="lblNoPermission" runat="server" resourcekey="lblNoPermission" CssClass="NormalRed"
    Visible="false"></asp:Label>
<asp:Label ID="lblSocial" runat="server" resourcekey="lblSocial" CssClass="NormalRed"
    Visible="false"></asp:Label>
