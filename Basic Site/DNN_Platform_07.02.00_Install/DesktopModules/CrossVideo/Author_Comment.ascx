<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Video.Author_Comment, App_Web_author_comment.ascx.24b431c5" %>
            ...
            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" CellPadding="1"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:Label ID="lblVideoTitleField" runat="server" Text='<%# Eval("VideoTitle") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <HeaderTemplate>
