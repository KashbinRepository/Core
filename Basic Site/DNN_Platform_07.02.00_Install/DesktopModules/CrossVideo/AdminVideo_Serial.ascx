<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Video.View.AdminVideo_Serial, App_Web_adminvideo_serial.ascx.24b431c5" %>
        ...
        <td>
            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Image ID="Image1" runat="server" ImageUrl='<%#Eval("Thumbnail")%>' Width='40'
                                BorderStyle="Solid" BorderWidth="1" BorderColor="DarkGray" ImageAlign="Left" />
                        </ItemTemplate>
                    </asp:TemplateField>
...
<table id="tblAttachment" cellspacing="0" cellpadding="2" width="100%" border="0" class="dnnFormItem" 
    ...
    <tr>
        <td colspan="2">
            ...
            <asp:GridView ID="gvAttachmentList" runat="server"  DataKeyNames="Id"
                Width="100%" AutoGenerateColumns="False" OnRowCommand="gvAttachmentList_RowCommand"
                ForeColor="#333333" CellPadding="1" CellSpacing="1" GridLines="None" BackColor="Gray">
...
<table width="100%" class="dnnFormItem"  runat="server" id="tblImageList" align="left">
    <tr >
        <td colspan="2">
            ...
            <asp:GridView ID="gvImageList" runat="server" AutoGenerateColumns="False" 
                Width="100%" CellPadding="1" CellSpacing="1" GridLines="None" BackColor="Gray" ForeColor="#333333"  DataKeyNames="Id"
        ...
        <td colspan="2">
            ...
            <asp:GridView ID="gvVideoList" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:Image ID="Image2" runat="server" ImageUrl='<%#Eval("Thumbnail")%>' Width='40'
                                BorderStyle="Solid" BorderWidth="1" BorderColor="DarkGray" ImageAlign="Left" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="left">
