<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Video.View.Author_Ticket, App_Web_author_ticket.ascx.24b431c5" %>
...
<table width="100%" class="dnnFormItem" cellpadding="0" cellspacing="0" border="0" runat="server"
    ...
    <tr>
        <td id="td_Button_Search" runat="server">
            ...
            <asp:TextBox ID="txtTitle" Columns="40" runat="server" Width="400px"/><br />
            <asp:Label ID="lblTicketId" runat="server" resourcekey="lblTicketId" />
            <asp:TextBox ID="txtTicketNo" Columns="40" runat="server" Width="400px"/><br />
    ...
    <tr>
        <td align="right">
            <asp:GridView ID="gvTicket" runat="server" AutoGenerateColumns="False" 
                Width="100%" CellPadding="1" CellSpacing="1" GridLines="None" BackColor="Gray" ForeColor="#333333" DataKeyNames="Id" OnRowCommand="gvTicket_RowCommand">
                <EmptyDataTemplate>
...
<table align="center" width="100%"  id="tblTicketDetail_List" runat="server"
    visible="false">
    <tr>
        <td>
            <hr style="border: 1px dotted #999999; size: 1" />
    ...
    <tr>
        ...
        <td>
            <asp:TextBox ID="txtTicketDescription" runat="server" Columns="60" TextMode="Multiline"
                Rows="8" />
            <asp:Image ID="Image2" runat="server" ImageUrl="~/DesktopModules/CrossVideo/images/required.jpg" ToolTip="Reuired" ImageAlign="Middle"
