<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Video.View.Author_YouTubeRss, App_Web_author_youtuberss.ascx.24b431c5" %>
    ...
    <tr>
        <td align="center">
            ...
            <dnn:CommandButton ID="btnAdd" runat="server" ImageUrl="~/images/add.gif" OnCommand="btnAdd_Click"
                ResourceKey="btnAdd" CausesValidation="false" />
            &nbsp; &nbsp;
    ...
    <div id="tabs" style="width: 100%; overflow: auto">
        ...
        <div id="divBasic" class="dnnFormItem" style="height: 100%">
            <table cellspacing="0" cellpadding="2" width="100%" border="0">
                ...
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label1" runat="server" resourcekey="Tip_BelongToSerial" CssClass="dnnFormMessage dnnFormInfo" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <dnn:Label ID="plBelongToSerial" runat="server" ControlName="ddlBelongToSerial" />
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlBelongToSerial" runat="server" Width="300px" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="Regularexpressionvalidator6" resourcekey="MustBeInteger"
                            ForeColor="Red" runat="server" ValidationExpression="\d*" ControlToValidate="txtMaxRecord" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label4" runat="server" resourcekey="Tip_ShareType" CssClass="dnnFormMessage dnnFormInfo" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlShareType" runat="server" AutoPostBack="True" Width="450px"  OnSelectedIndexChanged="ddlShareType_SelectedIndexChanged">
            ...
            <table cellspacing="2" cellpadding="2"  runat="server" id="tblStandardFeeds" width="100%" 
                visible="false">
                <tr>
                    <td style="width: 200px">
            ...
            <table cellspacing="2" cellpadding="2"  runat="server" id="tblUserSpecific" width="100%"
                visible="false">
                <tr>
                    <td style="width: 200px">
            ...
            <table cellspacing="2" cellpadding="2"  runat="server" id="tblCustomizeCategoryAndTag" width="100%"
                visible="false">
                <tr>
                    <td style="width: 200px">
            ...
            <table cellspacing="2" cellpadding="2" runat="server" id="tblAdvanced" width="100%">
                <tr>
                    <td style="width: 200px">
        ...
        <div id="divCategory" class="dnnFormItem" style="height: 100%">
            <table cellspacing="0" cellpadding="2" width="100%" border="0">
                <tr>
                    <td>
                        <asp:Label ID="lbl_Tip_SelectCategory" runat="server"  resourcekey="Tip_SelectCategory" CssClass="dnnFormMessage dnnFormInfo"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
