<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Video.View.AdminVideo_Tag, App_Web_adminvideo_tag.ascx.24b431c5" %>
...
<script type="text/javascript">
    function checkAll_Tag() {
        if ($(":checkbox[id*='chkAll_Tag']").prop("checked") == false) {
...
<table width="100%" cellpadding="1" cellspacing="1" class="dnnFormItem" align="center">
    <tr>
        <td align="center">
            ...
            <asp:DropDownList ID="ddlVideoType" runat="server" DataTextField="Name" DataValueField="Id" Width="200px"
