<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Author_Video.ascx.cs"
    Inherits="Cross.Modules.Video.View.Author_Video" %>
        ...
        <td>
            <asp:GridView ID="gvList" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:Label ID="lblRelatedInfo" runat="server" resourcekey="lblRelatedInfo" />
                        </HeaderTemplate>
                        <ItemTemplate>
    ...
    <div id="tabs" style="width: 100%; overflow: auto">
        <ul>
            ...
            <li><a href="#divDetail"><span>
                <%#Localization.GetString("divDetail", LocalResourceFile)%></span></a> </li>
            <%} %>
          
            <li runat="server" visible='<%#CurrentType.FieldEnable_Field1 %>'><a href="#divField1">
                <span>
                    <%#CurrentType.Field1Title%></span></a> </li>
            <li runat="server" visible='<%#CurrentType.FieldEnable_Field2 %>'><a href="#divField2">
                <span>
                    <%#CurrentType.Field2Title%></span></a> </li>
            <li runat="server" visible='<%#CurrentType.FieldEnable_Field3 %>'><a href="#divField3">
                <span>
                    <%#CurrentType.Field3Title%></span></a> </li>
            <li runat="server" visible='<%#CurrentType.FieldEnable_Field4 %>'><a href="#divField4">
                <span>
                    <%#CurrentType.Field4Title%></span></a> </li>
            <li runat="server" visible='<%#CurrentType.FieldEnable_Field5 %>'><a href="#divField5">
                <span>
        ...
        <div id="divBasic" class="dnnFormItem" style="height: 100%">
            <table cellspacing="0" cellpadding="2" width="100%" border="0">
                 <tr>
                    <td colspan="2">
                    <asp:Label ID="Label16" runat="server" resourcekey="Tip_ReadMediaFormat"
                ...
                <tr>
               <%-- <tr id="trHttpTypeTip" runat="server">--%>
                    <td colspan="2">
                        <asp:Label ID="Label4" runat="server" resourcekey="Tip_HttpType" CssClass="dnnFormMessage dnnFormInfo"
                             />
                    </td>
                </tr>
                <tr>
                <%--<tr id="trHttpType" runat="server">--%>
                    <td>
                ...
                <tr>
                    <td colspan="2">
                        <asp:Label ID="Label5" runat="server" resourcekey="Tip_DurationAndImage" CssClass="dnnFormMessage dnnFormInfo"
                            />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:DropDownList ID="ddlShareType" runat="server"  Width="450px" 
                        AutoPostBack="True" OnSelectedIndexChanged="ddlShareType_SelectedIndexChanged">
            ...
            <table cellspacing="0" cellpadding="2" width="100%" border="0">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="Regularexpressionvalidator4" resourcekey="MustBeDecimal" ForeColor="Red"
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="Regularexpressionvalidator3" resourcekey="MustBeDecimal" ForeColor="Red"
