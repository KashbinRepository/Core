<%@ control language="C#" autoeventwireup="true" inherits="Cross.Modules.Video.View.Reader_Abuse, App_Web_reader_abuse.ascx.24b431c5" %>
    ...
    <tr>
        <td align="right">
            <asp:GridView ID="gvAbuse" runat="server" AutoGenerateColumns="False" 
                Width="100%" CellPadding="1"  CellSpacing="1"  GridLines="None" BackColor="Gray" ForeColor="#333333" DataKeyNames="Id" OnRowCommand="gvAbuse_RowCommand">
                <EmptyDataTemplate>
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            <asp:CheckBox ID="chkVideoDeleted" runat="server" Enabled="false" Checked='<%#IsVideoDeleted(Convert.ToString(Eval("VideoId")),Convert.ToString(Eval("SubVideoId"))) %>' />
                        </ItemTemplate>
                        <ItemStyle HorizontalAlign="center" />
                    </asp:TemplateField>
...
<table align="center" width="100%" class="dnnFormItem" id="tblAbuseDetail_List" runat="server"
    visible="false">
    <tr>
        <td>
            <hr style="border: 1px dotted #999999; size: 1" />
