...
*/
	...
	function AssignVariableFromView(ChannelURL,PlaylistURL,DefaultTab,FeaturedVideoOnLoad,InLightbox, columns,width){
	youTubeChannelURL=ChannelURL;
	youTubePlaylistURL=PlaylistURL;
	youmaxDefaultTab=DefaultTab;
	showFeaturedVideoOnLoad=FeaturedVideoOnLoad;
	showVideoInLightbox=InLightbox;
	
	youmaxColumns = columns;	
	youmaxWidgetWidth = width;
	youmaxWidgetHeight = "";
