<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="GlobalSettingStyleEditor.ascx.cs" Inherits="MICROS.Modules.MyCentralSiteConfiguration.GlobalSettingStyleEditor" %>
